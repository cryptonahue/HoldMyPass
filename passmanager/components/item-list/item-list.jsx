...
const Index = () => {
    ...
    <div className="md:flex justify-between mb-5 ">
        <div><h2 className="font-bold text-3xl text-black mb-2">All Items</h2></div>
        <div className="flex">
            ...
            <div>
            <select className="select select-ghost w-full max-w-xs focus:bg-white hover:bg-white">
